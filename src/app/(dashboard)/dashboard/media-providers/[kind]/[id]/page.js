...
import { MEDIA_PROVIDER_KINDS, AI_PROVIDERS, getProviderAlias, isCustomEmbeddingProvider, isCustomImageProvider, resolveProviderId } from "@/shared/constants/providers";
...
function GenericExampleCard({ providerId, kind, providerAliasOverride = "", customNode = null }) {
  ...
  const allRefUrls = pendingRefImageUrl && refImageUrls.length < MAX_REF_IMAGE_COUNT
    ...
    : refImageUrls;
  const effectiveRefImage = allRefUrls[0] || imageEditDefaults.image || "";
