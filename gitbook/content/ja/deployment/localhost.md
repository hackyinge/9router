...
- **APIエンドポイント**: `http://localhost:20502/v1`
- **データディレクトリ**: `~/.9router`
...
APIポート(20502)とダッシュボードポート(3000)はアプリケーションで設定されています。変更するにはソースコードを修正するか、サポートされている場合は環境変数を使用してください。
