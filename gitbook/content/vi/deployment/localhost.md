...
Port API (20502) và port dashboard (3000) được cấu hình trong application. Để đổi, bạn cần sửa source code hoặc dùng biến môi trường nếu được hỗ trợ.
...
Nếu port 20502 hoặc 3000 đã được dùng:
