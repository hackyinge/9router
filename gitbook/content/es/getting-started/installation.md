...
**Qué sucede:**
1. El servidor inicia en `http://localhost:20502`
...
**Error:**
```
Error: listen EADDRINUSE: address already in use :::20502
```

**Solución 1: Mata el proceso existente**

```bash
# Encuentra proceso usando el puerto 20502
lsof -i :20502
...
server {
    ...
    location / {
        proxy_pass http://localhost:20502;
