...
- **API Endpoint**: `http://localhost:20502/v1`
...
El puerto de API (20502) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.
...
Si el puerto 20502 o 3000 ya está en uso:
