...
client = OpenAI(
    ...
    base_url="http://localhost:20502/v1"
)
...
const client = new OpenAI({
  ...
  baseURL: "http://localhost:20502/v1"
});
...
llm = ChatOpenAI(
    ...
    openai_api_base="http://localhost:20502/v1",
    temperature=0.7
)
...
llm = OpenAI(
    model="cc/claude-sonnet-4-20250514",
    api_key="your-api-key-from-dashboard",
    api_base="http://localhost:20502/v1"
)
...
openai.api_base = "http://localhost:20502/v1"
...
ROUTER_BASE_URL=http://localhost:20502/v1
...
curl http://localhost:20502/health
...
- Verifica que el puerto 20502 no esté bloqueado
...
- Verifica los modelos disponibles: `curl http://localhost:20502/v1/models`
