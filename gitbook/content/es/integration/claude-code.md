...
export ANTHROPIC_BASE_URL="http://localhost:20502/v1"
...
1. Verifica que 9Router esté corriendo: `curl http://localhost:20502/health`
2. Verifica que las variables de entorno estén configuradas correctamente
3. Asegúrate de que ningún firewall esté bloqueando el puerto 20502
